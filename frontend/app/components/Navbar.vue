      ...
      <div class="flex items-center gap-6 md:gap-8">
        ...
        <div class="flex items-center gap-4 text-neutral-700">
          ...
          <NuxtLink to="/cart" class="p-1 hover:text-amber-700 transition-colors relative" aria-label="Shopping Cart">
            ...
            <span v-if="totalItems > 0" class="absolute -top-1 -right-1 bg-amber-700 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center font-sans">{{ totalItems }}</span>
          </NuxtLink>
        </div>
      </div>
    </nav>
